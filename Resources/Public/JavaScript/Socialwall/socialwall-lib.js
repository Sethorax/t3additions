                ...
                facebook: {
                    ...
                    getData: function(account) {
                        var request_url, limit = 'limit=' + options.facebook.limit,
                            query_extention = '&access_token=' + options.facebook.access_token + '&callback=?' + '&locale=' + options.facebook.language;
                        switch (account[0]) {
                            case '@':
